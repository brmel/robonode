...
RT-domain motion module ([ARCHITECTURE.md](../docs/ARCHITECTURE.md)): plans → executive → **governor** → **AxisAdapter seam**, with the sim adapter proving invariant I5 (twin and real behind one interface).
